<footer class="main-footer">
    ...
    <strong>
        &copy; {{date('Y')}} Golden Forest Logistics CO.Ltd All Rights Reserved. <a href="#" target="_blank"><strong style="color:#EE4323;">A Product by Doctor with africa</strong></a>
    </strong>
</footer>
