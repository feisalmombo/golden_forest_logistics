...
(function() {
	...
	<div class="page-box  page-box--block">
			<a class="page-box__picture" href="#"><img width="360" height="240" data-srcset="{{asset('gfl/images/freight-services.jpg')}}" alt="Freight Services" data-src="#" data-sizes="(min-width: 992px) 360px, calc(100vw - 30px)" class="wp-post-image lazyload" src="#"></a>
	...
	<div class="page-box  page-box--block">
			<a class="page-box__picture" href="#"><img width="360" height="240" data-srcset="{{asset('gfl/images/land-services.jpg')}}" alt="Land Freight Services" data-src="#" data-sizes="(min-width: 992px) 360px, calc(100vw - 30px)" class="wp-post-image lazyload" src="#"></a>
		<div class="page-box__content">
	...
	<div class="page-box  page-box--block">
			<a class="page-box__picture" href="#"><img width="360" height="240" data-srcset="{{asset('gfl/images/customs-clearance-service.jpg')}}" alt="Customs Clearance Services" data-src="#" data-sizes="(min-width: 992px) 360px, calc(100vw - 30px)" class="wp-post-image lazyload" src="#"></a>
		<div class="page-box__content">
	...
	<div class="page-box  page-box--block">
			<a class="page-box__picture" href="#"><img width="360" height="240" data-srcset="{{asset('gfl/images/cargo-insurance.jpg')}}" alt="Cargo Insurance" data-src="#" data-sizes="(min-width: 992px) 360px, calc(100vw - 30px)" class="wp-post-image lazyload" src="#"></a>
		<div class="page-box__content">
...
<a class="read-more" href="#">READ MORE</a></div></div></div></div><div id="pgc-6-4-1" class="panel-grid-cell"><div id="panel-6-4-1-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="8"><div class="featured-widget panel-widget-style panel-widget-style-for-6-4-1-0"><h3 class="widget-title"><span class="widget-title__inline">Request A Quote</span></h3><div class="textwidget">
<br><br>
...
<div class="col-xs-12 col-sm-2"><img alt="Client1" data-src="{{asset('gfl/images/freightnet.png')}}" class="lazyload" src="#"></div>
</div>
</div>
</div>
...
Email: tkayiranga@goldenforest.co.tz</p>  --}}
		...
		</div></div><div id="pgc-6-10-1" class="panel-grid-cell"><div id="panel-6-10-1-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="18"><h3 class="widget-title"><span class="widget-title__inline">Kenya</span></h3><div class="textwidget"><p>Email: kenya_ops@goldenforest.co.tz</p>
</div>
		</div></div><div id="pgc-6-10-2" class="panel-grid-cell"><div id="panel-6-10-2-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="19"><h3 class="widget-title"><span class="widget-title__inline">Democratic Republic of Congo</span></h3>			<div class="textwidget"><p>email: drc_ops@goldenforest.co.tz</p>
</div>
		</div></div><div id="pgc-6-10-3" class="panel-grid-cell"><div id="panel-6-10-3-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="20"><h3 class="widget-title"><span class="widget-title__inline">Kitwe</span></h3>			<div class="textwidget"><p>Email: kitwe@goldenforest.co.tz</p>
</div>
		</div></div></div><div id="pg-6-11" class="panel-grid panel-no-style"><div id="pgc-6-11-0" class="panel-grid-cell"><div id="panel-6-11-0-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="21"><h3 class="widget-title"><span class="widget-title__inline">Burundi</span></h3>			<div class="textwidget"><p>bujumbura@goldenforest.co.tz</p>
</div>
		</div></div><div id="pgc-6-11-1" class="panel-grid-cell"><div id="panel-6-11-1-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="22"><h3 class="widget-title"><span class="widget-title__inline">Congo Brazza</span></h3>			<div class="textwidget"><p>email: congo_ops@goldenforest.co.tz</p>
</div>
		</div></div><div id="pgc-6-11-2" class="panel-grid-cell panel-grid-cell-mobile-last"><div id="panel-6-11-2-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="23"><h3 class="widget-title"><span class="widget-title__inline">Uganda</span></h3>			<div class="textwidget"><p>email: Uganda_ops@goldenforest.co.tz</p>
</div>
